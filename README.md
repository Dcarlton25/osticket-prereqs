...
Now, you will need to head back to osTicket installer and click "continue", and after that you will need to give your help desk a name, an email, and an admin user profile. After that, you need to download heidiSQL, and then go back to file explorer, then downloads, then double cliclk "heidiSQL" and install the application.
